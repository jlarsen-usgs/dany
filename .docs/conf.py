...
cmd = "sphinx-apidoc -e -o source/ ../dany/"
print(cmd)
os.system(cmd)

# todo: continue updates through toolchain
...
if on_rtd:
    ...
    rtds_action_github_repo = "jlarsen-usgs/dany"
