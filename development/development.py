...
from dany import fill_sinks, FlowDirections, Sfr6, Sfr2005, PrmsStreams
...
resampled_dem = os.path.join(data_ws, "dem50.txt")
pp_file = os.path.join(data_ws, "model_points.shp")
